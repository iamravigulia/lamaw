...
namespace edgewizz\lamaw\Controllers;

use App\Http\Controllers\Controller;
use App\Models\Media;
use Edgewizz\Edgecontent\Models\ProblemSetQues;
use Edgewizz\Lamaw\Models\LamawAns;
use Edgewizz\Lamaw\Models\LamawQues;
use Illuminate\Http\Request;

class LamawController extends Controller
{
    //
    ...
    public function update($id, Request $request){
        ...
        $q->hint = $request->hint;
        $q->save();
        $answers = LamawAns::where('question_id', $q->id)->get();
